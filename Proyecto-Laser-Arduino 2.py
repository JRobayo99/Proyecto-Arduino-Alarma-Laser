...
class Fotocelda:
    ...
    def luz_Laser():
      if self.info_laser.Encender_Apagar == True and self.info_Arduino.Encender_Apagar == True:
        if self.Estado == True:
          return True
      elif self.info_laser.Encender_Apagar == True and self.info_Arduino.Encender_Apagar == True:
...
class Buzzer:
    ...
    def Encender_Apagar():
      if self.info_Arduino.Encender_Apagar == True and self.info_Fotocelda.luz_Laser == False:
        self.Estado = True
      elif self.info_Arduino.Encender_Apagar == True and self.info_Fotocelda.luz_Laser == True:
        self.Estado = False
      return self.Estado
